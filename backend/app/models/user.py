...
class User(Base):
    ...
    email_verified = Column(Integer, default=0, server_default="0")
    verified_at = Column(DateTime)
    onboarding_completed = Column(Integer, default=0, server_default="0")
...
class UserSettings(Base):
    ...
    notifications_enabled = Column(Integer, default=1, server_default="1")
    coach_style = Column(String(50), default="strategic", server_default="strategic")
    daily_reminder_time = Column(String(50), default="08:00", server_default="08:00")
    profile_visibility = Column(String(50), default="public", server_default="public")
    created_at = Column(DateTime, default=lambda: datetime.now(UTC), server_default=func.now())
