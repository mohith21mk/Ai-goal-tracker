...
from .social import CommunityPost, CommunityLike, CommunityComment, UserConnection, Conversation, ConversationMember, Message, ChatMessage, Notification, AIActivityLog
...
__all__ = [
    ...
    "CommunityPost", "CommunityLike", "CommunityComment", "UserConnection", "Conversation", "ConversationMember", "Message", "ChatMessage", "Notification", "AIActivityLog",
